    ...
    <div className="overflow-hidden rounded-3xl border border-zinc-900/10 bg-white shadow-sm">
      ...
      <div className="grid gap-5 px-6 py-6">
        <div className="grid gap-2">
          ...
          <textarea
            id="eventThingsToKnow"
            className="min-h-[110px] w-full resize-none rounded-xl border border-zinc-900/10 bg-white px-3 py-2 text-sm shadow-sm outline-none transition focus:border-zinc-900/20 focus:bg-zinc-50"
            value={thingsToKnow}
            onChange={(e) => onThingsToKnow(e.target.value)}
        ...
        <div className="grid gap-2">
          ...
          <textarea
            ...
            className="min-h-[110px] w-full resize-none rounded-xl border border-zinc-900/10 bg-white px-3 py-2 text-sm shadow-sm outline-none transition focus:border-zinc-900/20 focus:bg-zinc-50"
            value={amenities}
            onChange={(e) => onAmenities(e.target.value)}
            placeholder="Optional"
          />
        </div>
